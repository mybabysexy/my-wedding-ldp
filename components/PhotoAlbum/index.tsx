        ...
        <div className='container'>
            ...
            <motion.div className={'grid grid-cols-2 md:grid-cols-3 gap-2'}
                ...
                <motion.div
                    ...
                    className={'relative transition hover:shadow-2xl cursor-zoom-in rounded-2xl overflow-hidden h-[200px] md:h-auto md:min-h-[350px]'}>
                    <Image placeholder={'blur'} quality={80} src={PHOTO_1} alt={'Ảnh 1'} fill
                           className={'object-cover object-top'}/>
                </motion.div>
                <motion.div
                    whileHover={whileHoverAnimation}
                    className={'relative transition hover:shadow-2xl cursor-zoom-in row-span-2 rounded-2xl overflow-hidden md:min-h-[350px]'}>
                ...
                <motion.div
                    whileHover={whileHoverAnimation}
                    className={'relative transition hover:shadow-2xl cursor-zoom-in md:row-span-2 rounded-2xl overflow-hidden h-[200px] md:h-auto md:min-h-[350px]'}>
                ...
                <motion.div
                    whileHover={whileHoverAnimation}
                    className={'relative transition hover:shadow-2xl cursor-zoom-in col-span-2 rounded-2xl overflow-hidden h-[200px] md:h-auto md:min-h-[450px]'}>
